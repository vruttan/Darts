...
const STRINGS = {
  en: {
    ...
    recommendedBoards: "{count} is the recommended number of boards for {teams} teams.",
    ...
    chooseChampionshipBoard: "Which board will host the Championship match?",
  ...
  es: {
    ...
    recommendedBoards: "{count} es el número recomendado de dianas para {teams} equipos.",
    ...
    chooseChampionshipBoard: "¿Qué diana albergará la partida del Campeonato?",
